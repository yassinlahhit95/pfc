<?php
	...
	$query="SELECT ID , Nombre , Apellidos , DNI , Telefono , Email , Estudios , Ciclo_1 , Ciclo_2 , Ciclo_3, Preinscripcion, Registro FROM espera WHERE DNI ='" .utf8_encode($subs_dni). "'";
