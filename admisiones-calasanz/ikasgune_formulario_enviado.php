        ...
        <div class="col-lg-3">
          <div class="testimonial-item mx-auto mb-5 mb-lg-0">
            ...
            <p class="font-weight-light mb-0">
              Desde <a href='https://calasanz.eus/calendario-matriculacion-ikasgune' target='new'><b>este enlace</b></a> podrás reservar una cita en la fecha y hora que mejor se adapte a tu agenda.</p>
          </div>
        </div>
        <!-- Fin circulo 3 -->
        <!-- Comienzo circulo 4 -->
