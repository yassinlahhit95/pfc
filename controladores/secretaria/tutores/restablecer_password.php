<?php
// ══════════════════════════════════════════════════════════════════════
// RESTABLECER CONTRASEÑA DE UN TUTOR (Sistema Parental) — secretaría
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST' || !Security::validateCSRFToken()) {
    ...
    header("Location: ../../../vistas/secretaria/tutores/verTutores.php");
    exit;
}
...
if (!$tutor) {
    ...
    registrarAccionSecretaria('actualizar', 'tutores', $idTutor, 'Contraseña restablecida: ' . $tutor['nombreTutor']);
