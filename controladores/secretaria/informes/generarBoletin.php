...
$_back = $_base . '/vistas/secretaria/informes/informes.php';
...
// o generar el PDF (target="_blank") consumiría el token compartido con las otras
// formularios de esta misma página (generarListado.php, generarHorario.php).
