...
Future<bool> showCobrarPagoSheet(
  ...
  final montoController =
      TextEditingController(text: deudaActual.toStringAsFixed(2));
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(
                      value: 'mensual', child: Text('Mensualidad')),
                  DropdownMenuItem(
              ...
              OutlinedButton.icon(
                ...
                label: Text(archivo == null
                    ? 'Foto del justificante de pago (opcional)'
                    : 'Foto adjuntada'),
              ),
              const SizedBox(height: Space.xl),
              FilledButton(
                onPressed: () async {
                  ...
                  if (montoVal <= 0) {
                    await showErrorAlert(
                        ctx, 'El monto debe ser un número válido mayor a 0.');
                    return;
                  }
                  try {
                    await ref
                        ...
                        .registrarCobroPago(
                          ...
                          tipoPago: tipoPago,
                          fechaProximoPago:
                              proximoPagoController.text.isNotEmpty
                                  ? proximoPagoController.text
                                  : null,
                          archivo: archivo,
                        );
                    ...
                    if (ctx.mounted) {
                      await showErrorAlert(
                          ctx, 'No se pudo registrar el pago.');
                    }
                  }
                },
