...
/**
 * Crea una nueva solicitud de pre-matrícula
 */
function crearPreMatricula($dni, $nombre, $apellidos, $email, $telefono, $idCiclo, $curso = '1º') {
    $con = obtenerConexion();
    $sql = "INSERT INTO pre_matriculas (dni, nombre, apellidos, email, telefono, idCiclo, curso) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare($con, $sql);
    mysqli_stmt_bind_param($stmt, "sssssis", $dni, $nombre, $apellidos, $email, $telefono, $idCiclo, $curso);
...
/**
 * Actualiza el estado de una pre-matrícula
 */
...
/**
 * Obtiene los archivos de una pre-matrícula
 */
...
/**
 * Lista todas las pre-matrículas (para admin)
 */
