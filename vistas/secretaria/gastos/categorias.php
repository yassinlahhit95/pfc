                        ...
                        <div class="recurso-menu-wrap">
                            ...
                            <div class="recurso-menu">
                                ...
                                <a class="recurso-menu-item peligro" href="#"
                                   ...
                                   data-tipo="Categoría"
                                   data-nombre="<?= Security::escapeHtml($cat['nombre']) ?>"
                                   data-url="/controladores/secretaria/categorias_gasto/borrar.php"
...
(function () {
    ...
    $('#form-categoria').on('submit', function (e) {
        ...
        var isEdit = !!$id.val();
        var url    = isEdit
            ? '/controladores/secretaria/categorias_gasto/actualizar.php'
            : '/controladores/secretaria/categorias_gasto/insertar.php';
