...
// Ownership: el profesor solo puede editar FCT de sus propios alumnos.
...
if (!isset($misEstudiantes[(int)$fct['idEstudiante']])) {
    $_SESSION['errores'] = 'No tienes acceso a esta FCT.';
    header('Location: lista.php'); exit;
}
...
<div class="panel">
    <form method="POST" action="../../../controladores/profesores/fct/actualizar.php" class="formulario">
