                        ...
                        <tr>
                            ...
                            <td>
                                <div class="botones-accion">
                                    ...
                                    <form action="../../../controladores/profesores/retos/borrar.php" method="POST" onsubmit="return confirm('Â¿EstÃ¡ seguro de que desea eliminar este reto?');" class="display-inline">
