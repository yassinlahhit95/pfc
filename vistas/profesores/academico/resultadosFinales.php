...
if ($id_ciclo_elegido) :
    ...
    foreach ($estudiantes_lista as $estudianteIndividual) :
        ...
        foreach ($lista_modulos as $moduloItem) :
            ...
            $notasDeEsteModulo = [];
            if (isset($notas_mod['nota_1ev']) && is_numeric($notas_mod['nota_1ev']) && $notas_mod['nota_1ev'] > 0) : $notasDeEsteModulo[] = $notas_mod['nota_1ev']; endif;
            if (isset($notas_mod['nota_1final']) && is_numeric($notas_mod['nota_1final']) && $notas_mod['nota_1final'] > 0) : $notasDeEsteModulo[] = $notas_mod['nota_1final']; endif;
            if (isset($notas_mod['nota_2ev']) && is_numeric($notas_mod['nota_2ev']) && $notas_mod['nota_2ev'] > 0) : $notasDeEsteModulo[] = $notas_mod['nota_2ev']; endif;
            if (isset($notas_mod['nota_2final']) && is_numeric($notas_mod['nota_2final']) && $notas_mod['nota_2final'] > 0) : $notasDeEsteModulo[] = $notas_mod['nota_2final']; endif;
                ...
                <tbody>
                    ...
                    <?php else : ?>
                        <?php foreach ($datos_finales as $filaIndividual) : 
                            ...
                            if ($filaIndividual['estado'] == "APROBADO") : $clase_estado = "texto-verde"; endif;
                            if ($filaIndividual['estado'] == "PENDIENTE") : $clase_estado = "texto-gris"; endif;
                        ?>
                        <tr>
