<?php
// ══════════════════════════════════════════════════════════════════════
// Cuerpo compartido de vistas/{admin,secretaria}/blog/agregarPost.php
// El wrapper de cada rol ya resolvió el Guard, el nav, y debe definir
// $datos, $categorias, $errores y $blogRolBase ('admin' | 'secretaria')
...
<div class="panel">
    <form method="POST" action="../../../controladores/<?= $blogRolBase ?>/blog/insertar.php" enctype="multipart/form-data">
