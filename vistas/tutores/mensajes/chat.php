<?php
$seccion      = 'chat';
$titulo_pagina = 'Mensajería — Familia';
...
<div class="chat-page" id="chat-page">
  ...
  <div class="chat-sidebar">
    ...
    <div class="chat-conv-list">
      <?php if (empty($convs)): ?>
        <div class="chat-empty-sidebar">No tiene mensajes aún.<br>Contacte con un profesor o con el centro.</div>
      ...
      ?>
        <a href="conversacion.php?id=<?= (int)$conversacion['id'] ?>" class="chat-conv-row">
  ...
  <div class="chat-main">
    <div class="chat-placeholder">
      ...
      <p>Seleccione una conversación o contacte con un docente</p>
    </div>
  </div>
</div>
...
<div class="chat-modal-overlay" id="chat-modal-overlay" style="display:none">
  <div class="chat-modal">
    ...
    <h3>Contactar con el Centro</h3>
    <p class="small text-muted mb-3">Busque a los profesores de sus hijos o al equipo directivo.</p>
