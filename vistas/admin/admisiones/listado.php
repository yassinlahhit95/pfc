...
$titulo_pagina = 'Gestión de Admisiones';
$seccion       = 'admisiones';
        ...
        <div style="padding:24px 28px;display:grid;grid-template-columns:1fr 1fr;gap:24px;flex:1;">
            ...
            <div class="detalle-seccion">
                ...
                <div class="campo">
                    ...
                    <textarea id="admObs" rows="4" class="campo-input" placeholder="Observaciones..."></textarea>
                </div>

                <div class="detalle-seccion-titulo" style="margin-top:16px;"><i class="fas fa-paperclip"></i> Documentos</div>
...
$('#admGuardar').on('click', function() {
    ...
    $.post('../../../controladores/admin/admisiones_acciones.php?action=update_status', {
        id: currentId,
