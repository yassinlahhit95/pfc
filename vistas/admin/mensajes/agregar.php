    ...
    <form action="../../../controladores/admin/mensajes/insertar.php" method="POST">
        ...
        <div class="formulario-cuadricula margen-abajo">
            <div class="campo-formulario">
                ...
                <select onchange="window.location.href='?tipoDestinatario=estudiante&idCiclo='+this.value" class="mt-5">
            ...
            <div class="campo-formulario">
                ...
                <select name="idEstudiante" class="mt-5 ancho-total">
        ...
        <div class="campo-formulario margen-abajo">
            ...
            <select name="idProfesor" class="mt-5 ancho-total">
