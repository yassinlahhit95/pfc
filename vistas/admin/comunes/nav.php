...
<header class="navbar-superior">
    ...
    <div class="menu-superior">
        <ul class="navbar-nav">
            <li><a href="/pfc/vistas/admin/directores/perfil.php"><i class="fas fa-user-circle"></i> Mi Perfil</a></li>
...
<div class="contenedor-principal">
    <aside class="barra-lateral" id="barraLateral">
        ...
        <nav class="menu-navegacion">
            <a href="/pfc/vistas/admin/dashboard.php" class="enlace-menu <?= ($seccion == 'inicio') ? 'activo' : '' ?>">
            ...
            <div class="seccion-del-menu">
                ...
                <a href="/pfc/vistas/admin/estudiantes/verEstudiantes.php" class="enlace-menu <?= ($seccion == 'estudiantes') ? 'activo' : '' ?>">
                    <i class="fas fa-user-graduate"></i> <span>ESTUDIANTES</span>
                    <span class="etiqueta-contador"><?= $_nEstudiantes ?></span>
                </a>

                <a href="/pfc/vistas/admin/ciclos/verCiclos.php" class="enlace-menu <?= ($seccion == 'ciclos') ? 'activo' : '' ?>">
                    <i class="fas fa-layer-group"></i> <span>CICLOS FORMATIVOS</span>
                    <span class="etiqueta-contador"><?= $_nCiclos ?></span>
                </a>

                <a href="/pfc/vistas/admin/modulos/verModulos.php" class="enlace-menu <?= ($seccion == 'modulos') ? 'activo' : '' ?>">
                    <i class="fas fa-book"></i> <span>MÓDULOS</span>
                    <span class="etiqueta-contador"><?= $_nModulos ?></span>
                </a>

                <a href="/pfc/vistas/admin/retos/verRetos.php" class="enlace-menu <?= ($seccion == 'retos') ? 'activo' : '' ?>">
                    <i class="fas fa-tasks"></i> <span>RETOS / PROYECTOS</span>
                    <span class="etiqueta-contador"><?= $_nRetos ?></span>
                </a>

                <a href="/pfc/vistas/admin/academico/calificacionesModulos.php" class="enlace-menu <?= ($seccion == 'notas_modulos') ? 'activo' : '' ?>">
                    <i class="fas fa-graduation-cap"></i> <span>NOTAS MÓDULOS</span>
                </a>

                <a href="/pfc/vistas/admin/academico/calificacionesRetos.php" class="enlace-menu <?= ($seccion == 'notas_retos') ? 'activo' : '' ?>">
                    <i class="fas fa-tasks"></i> <span>NOTAS RETOS</span>
                </a>

                <a href="/pfc/vistas/admin/academico/resultadosFinales.php" class="enlace-menu <?= ($seccion == 'resultados_modulos') ? 'activo' : '' ?>">
                    <i class="fas fa-check-double"></i> <span>RESULTADOS FINALES</span>
                </a>

                <a href="/pfc/vistas/admin/pfc/verTFGs.php" class="enlace-menu <?= ($seccion == 'tfg') ? 'activo' : '' ?>">
            ...
            <div class="seccion-del-menu">
                ...
                <a href="/pfc/vistas/admin/directores/verDirectores.php" class="enlace-menu <?= ($seccion == 'directores') ? 'activo' : '' ?>">
                    <i class="fas fa-user-tie"></i> <span>DIRECTORES</span>
                    <span class="etiqueta-contador"><?= $_nDirectores ?></span>
                </a>

                <a href="/pfc/vistas/admin/profesores/verProfesores.php" class="enlace-menu <?= ($seccion == 'profesores') ? 'activo' : '' ?>">
                    <i class="fas fa-chalkboard-teacher"></i> <span>PROFESORES</span>
                    <span class="etiqueta-contador"><?= $_nProfesores ?></span>
                </a>

                <a href="/pfc/vistas/admin/pagos/verPagosGeneral.php" class="enlace-menu <?= ($seccion == 'pagos') ? 'activo' : '' ?>">
                    <i class="fas fa-wallet"></i> <span>PAGOS</span>
                    <span class="etiqueta-contador"><?= $_nPagos ?></span>
                </a>

                <a href="/pfc/vistas/admin/eventos/gestionEventos.php" class="enlace-menu <?= ($seccion == 'eventos') ? 'activo' : '' ?>">
                    <i class="fas fa-calendar-alt"></i> <span>EVENTOS</span>
                </a>

                <a href="/pfc/vistas/admin/anuncios/gestionAnuncios.php" class="enlace-menu <?= ($seccion == 'anuncios') ? 'activo' : '' ?>">
                    <i class="fas fa-bullhorn"></i> <span>AVISOS Y PUSH</span>
                    <span class="etiqueta-contador"><?= $_nAnuncios ?></span>
                </a>

                <a href="/pfc/vistas/admin/mensajes/lista.php" class="enlace-menu <?= ($seccion == 'reclamaciones') ? 'activo' : '' ?>">
            ...
            <div class="seccion-del-menu">
                ...
                <a href="/pfc/vistas/admin/aulas/verAulas.php" class="enlace-menu <?= ($seccion == 'aulas') ? 'activo' : '' ?>">
                    <i class="fas fa-door-open"></i> <span>AULAS</span>
                    <span class="etiqueta-contador"><?= $_nAulas ?></span>
                </a>

                <a href="/pfc/vistas/admin/inventario/verInventario.php" class="enlace-menu <?= ($seccion == 'inventario') ? 'activo' : '' ?>">
                    <i class="fas fa-boxes"></i> <span>INVENTARIO</span>
                    <span class="etiqueta-contador"><?= $_nInventario ?></span>
                </a>

                <a href="/pfc/vistas/admin/inventario/gestionarPrestamos.php" class="enlace-menu <?= ($seccion == 'prestamos') ? 'activo' : '' ?>">
            ...
            <div class="separador-menu-inferior">
                <a href="/pfc/vistas/admin/directores/perfil.php" class="enlace-menu <?= ($seccion == 'perfil') ? 'activo' : '' ?>">
                    <i class="fas fa-user-circle"></i> <span>MI PERFIL</span>
                </a>
                <a href="/pfc/vistas/admin/comunes/sobreelproyecto.php" class="enlace-menu <?= ($seccion == 'creditos') ? 'activo' : '' ?>">
