                    ...
                    <tr>
                        ...
                        <td>
                            <div class="botones-accion">
                                ...
                                <form action="../../../controladores/admin/pagos/borrar.php" method="POST" style="display: inline;" onsubmit="return confirm('¿Está seguro de eliminar este registro de pago?')">
