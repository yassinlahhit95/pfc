...
<div class="cabecera">
    <div>
        ...
        <p class="subtitulo-encabezado">Alta y seguimiento de las prácticas de todo el centro.</p>
    </div>
    <a href="agregar.php?idCiclo=<?= $idCicloSeleccionado ?>" class="boton-primario"><i class="fas fa-plus"></i> Nueva FCT</a>
</div>
...
<div class="panel">
    <?php if (empty($fcts)): ?>
        <div class="panel-vacio">
            ...
            <div class="panel-vacio-desc">Todavía no hay ninguna FCT dada de alta para este ciclo.</div>
        </div>
    <?php else: ?>
                        ...
                        <div class="recurso-menu-wrap">
                            ...
                            <div class="recurso-menu">
                                ...
                                <a class="recurso-menu-item peligro" href="#"
                                   ...
                                   data-url="/controladores/admin/fct/borrar.php"
                                   data-campo="idFCT">
