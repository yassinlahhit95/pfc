                    ...
                    <?php foreach ($justificaciones as $j): ?>
                        <tr>
                            ...
                            <td style="text-align:right; white-space:nowrap;">
                                <?php if ($j['estado'] === 'pendiente'): ?>
                                    <form method="POST" action="../../../controladores/admin/asistencias/resolver_justificacion.php" style="display:inline;">
                                ...
                                <a href="#" class="boton-peligro btn-xs" style="background:#fee2e2; color:#ef4444;" title="Eliminar Justificación"
                                   ...
                                   data-url="/controladores/admin/asistencias/borrar_justificacion.php"
...
<div class="capa-bloqueo-modal" id="modalCrear" hidden>
    <div class="caja-modal" style="max-width:500px;">
        ...
        <form method="POST" action="../../../controladores/admin/asistencias/insertar_justificacion.php" enctype="multipart/form-data">
            <input type="hidden" name="csrf_token" value="<?= Security::generateCSRFToken() ?>">
...
<div class="capa-bloqueo-modal" id="modalRechazar" hidden>
    <div class="caja-modal" style="max-width:450px;">
        ...
        <form method="POST" action="../../../controladores/admin/asistencias/resolver_justificacion.php">
            <input type="hidden" name="csrf_token" value="<?= Security::generateCSRFToken() ?>">
...
function cargarFaltasEstudiante(idEstudiante) {
    ...
    fetch('../../../controladores/admin/asistencias/obtener_faltas_json.php?idEstudiante=' + idEstudiante)
