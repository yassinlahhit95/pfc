...
<div class="cuadricula-estadisticas">
  <div class="tarjeta-estadistica tarjeta-estadistica-verde">
    <div class="info-estadistica">
        <h3><?= number_format($datosEstadoFinanciero['totalPagado'], 2) ?> Ä</h3>
        <p>TOTAL PAGADO</p>
    </div>
  </div>
  <div class="tarjeta-estadistica tarjeta-estadistica-azul">
    <div class="info-estadistica">
        <h3><?= number_format($datosEstadoFinanciero['precioCiclo'], 2) ?> Ä</h3>
  ...
  <div class="tarjeta-estadistica <?= ($datosEstadoFinanciero['restante'] > 0) ? 'tarjeta-estadistica-naranja' : 'tarjeta-estadistica-cian' ?>">
    <div class="info-estadistica">
        <h3><?= number_format($datosEstadoFinanciero['restante'], 2) ?> Ä</h3>
            ...
            <tbody>
                ...
                <?php } else { ?>
                    ...
                    <tr>
                        ...
                        <td class="texto-negrita"><?= number_format($pagoIndividual['monto'], 2) ?> Ä</td>
                        <td>
                            <?php 
...
<div class="margen-arriba tarjeta-gris-suave">
    <p><i class="fas fa-info-circle"></i> Si detectas alg√∫n error en tus pagos, por favor contacta con administraci√≥n a trav√©s de la secci√≥n de mensajer√≠a.</p>
</div>
