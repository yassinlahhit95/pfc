...
<header class="navbar-superior">
    ...
    <div class="menu-superior">
        <ul class="navbar-nav">
            <li><a href="../../../vistas/estudiantes/perfil/ver.php"><i class="fas fa-user-circle"></i> Mi Perfil</a></li>
    ...
    <aside class="barra-lateral" id="barraLateral">
        ...
        <nav class="menu-navegacion">
            ...
            <div class="seccion-del-menu">
                ...
                <a href="../../../vistas/estudiantes/retos/lista.php" class="enlace-menu <?= ($seccionActual == 'retos') ? 'activo' : '' ?>">
                    <i class="fas fa-tasks"></i> <span>MIS RETOS</span>
                    <span class="etiqueta-contador"><?= $_nRetosEst ?></span>
                </a>

                <a href="../../../vistas/estudiantes/calificaciones/lista.php" class="enlace-menu <?= ($seccionActual == 'calificaciones') ? 'activo' : '' ?>">
                    <i class="fas fa-graduation-cap"></i> <span>MIS NOTAS</span>
                </a>

                <a href="../../../vistas/estudiantes/calificaciones/retos.php" class="enlace-menu <?= ($seccionActual == 'notas_retos') ? 'activo' : '' ?>">
                    <i class="fas fa-tasks"></i> <span>MIS NOTAS RETOS</span>
                </a>

                <a href="../../../vistas/estudiantes/academico/resultadosFinales.php" class="enlace-menu <?= ($seccionActual == 'resultados_finales') ? 'activo' : '' ?>">
                    <i class="fas fa-check-double"></i> <span>RESULTADOS FINALES</span>
                </a>

                <a href="../../../vistas/estudiantes/pfc/subir.php" class="enlace-menu <?= ($seccionActual == 'tfg') ? 'activo' : '' ?>">
            ...
            <div class="seccion-del-menu">
                ...
                <a href="../../../vistas/estudiantes/anuncios/lista.php" class="enlace-menu <?= ($seccionActual == 'anuncios') ? 'activo' : '' ?>">
                    <i class="fas fa-bullhorn"></i> <span>ANUNCIOS</span>
                    <span class="etiqueta-contador"><?= $_nAnunciosEst ?></span>
                </a>

                <a href="../../../vistas/estudiantes/mensajes/lista.php" class="enlace-menu <?= ($seccionActual == 'reclamaciones') ? 'activo' : '' ?>">
                    <i class="fas fa-envelope"></i> <span>MENSAJERÍA</span>
                    <span class="etiqueta-contador <?= ($_nSinLeerEst > 0) ? 'alerta-roja' : '' ?>"><?= $_nMensajesEst ?></span>
                </a>

                <a href="../../../vistas/estudiantes/pagos/lista.php" class="enlace-menu <?= ($seccionActual == 'pagos') ? 'activo' : '' ?>">
                    <i class="fas fa-credit-card"></i> <span>MIS PAGOS</span>
                    <span class="etiqueta-contador"><?= $_nPagosEst ?></span>
                </a>

                <a href="../../../vistas/estudiantes/eventos/lista.php" class="enlace-menu <?= ($seccionActual == 'eventos') ? 'activo' : '' ?>">
                    <i class="fas fa-calendar-alt"></i> <span>EVENTOS</span>
                </a>
            </div>

            <div class="separador-menu-inferior">
                <a href="../../../vistas/estudiantes/perfil/ver.php" class="enlace-menu <?= ($seccionActual == 'perfil') ? 'activo' : '' ?>">
                    <i class="fas fa-user-circle"></i> <span>MI PERFIL</span>
                </a>
                <a href="../../../vistas/estudiantes/comunes/sobreelproyecto.php" class="enlace-menu <?= ($seccionActual == 'creditos') ? 'activo' : '' ?>">
